...
public class JwtAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        TokenModel tokenModel = buildJwtTokenModel(jwtAuthenticationToken);
    ...
    private TokenModel buildJwtTokenModel(JwtAuthenticationToken jwtAuthenticationToken) {
    ...
    public void validateAuthFilterToken(TokenModel model) {
        ...
        if (!encoder.matchTokens(model.getToken(), auth.getAccessToken())) {
    ...
    public JwtAuthenticationToken buildToken(UserDataResponseModel user) {
